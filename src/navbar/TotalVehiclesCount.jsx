...
const TotalVehiclesCount = () => {
  ...
  return (
    ...
    >
      <div className="pr-4">
        <span className="font-bold text-sm text-gray-700">Running : </span>
        <span className="font-bold text-sm text-green-700">{count.RUNNING}</span>
      </div>
      <div className="pr-4">
        <span className="font-bold text-sm text-gray-700">Idle : </span>
        <span className="font-bold text-sm text-yellow-500">{count.IDLE}</span>
      </div>
      <div className="pr-4">
        {totalVehicles > 0 && (
          <div>
            ...
            <span className="font-bold text-sm text-[#fc6a2a]">
              {totalVehicles}{" "}
            </span>
            <VehicleStatus
